    ...
    return(
        <div className="h-3/6 bg-[#6A5BE2] rounded-3xl w-full items-start">
            <section className="h-2/6 py-8 ">
                ...
                <h2 className="text-5xl text-white tracking-wider text-center mt-8 font-bold">{displayMessage(totalPercentage)}</h2>
            </section>
            <div className="w-11/12 mx-auto">
                ...
                <section className="h-2/6 py-4 grid grid-cols-3 justify-items-center">
                    ...
                    <h2 className="text-3xl text-white font-bold">{totalPercentage} %</h2>
                </section>
            </div>
